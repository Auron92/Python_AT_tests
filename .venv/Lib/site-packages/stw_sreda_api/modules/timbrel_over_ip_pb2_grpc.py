...
class TimbrelOverIpModuleServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.TimbrelReqRep = channel.stream_stream('/sreda.grpc.gen.timbrel.v2.TimbrelOverIpModuleService/TimbrelReqRep', request_serializer=timbrel__messages__pb2.TimbrelReqRepMessage.SerializeToString, response_deserializer=timbrel__messages__pb2.TimbrelReqRepMessage.FromString)
        self.TimbrelTelemetry = channel.stream_stream('/sreda.grpc.gen.timbrel.v2.TimbrelOverIpModuleService/TimbrelTelemetry', request_serializer=timbrel__messages__pb2.TimbrelTelemetryMessage.SerializeToString, response_deserializer=timbrel__messages__pb2.TimbrelTelemetryMessage.FromString)
        self.TimbrelEvent = channel.stream_stream('/sreda.grpc.gen.timbrel.v2.TimbrelOverIpModuleService/TimbrelEvent', request_serializer=timbrel__messages__pb2.TimbrelEventMessage.SerializeToString, response_deserializer=timbrel__messages__pb2.TimbrelEventMessage.FromString)
        self.Statistics = channel.unary_stream('/sreda.grpc.gen.timbrel.v2.TimbrelOverIpModuleService/Statistics', request_serializer=common__pb2.Empty.SerializeToString, response_deserializer=timbrel__messages__pb2.TimbrelStatisticsMessage.FromString)

class TimbrelOverIpModuleServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_TimbrelOverIpModuleServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler('sreda.grpc.gen.timbrel.v2.TimbrelOverIpModuleService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))

class TimbrelOverIpModuleService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Statistics(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_stream(request, target, '/sreda.grpc.gen.timbrel.v2.TimbrelOverIpModuleService/Statistics', common__pb2.Empty.SerializeToString, timbrel__messages__pb2.TimbrelStatisticsMessage.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)