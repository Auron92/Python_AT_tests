...
class BusOffStats(_Message):
    ...
    # Непрерывное время последнего перехода CAN-шины в состояние Bus off
    busOffTimeUp: Up
    # Бортовое время последнего перехода CAN-шины в состояние Bus off
    busOffTimeGps: Gps


class BusOffStatsDict(TypedDict):
    ...
    # Непрерывное время последнего перехода CAN-шины в состояние Bus off
    busOffTimeUp: Union[Up]

    # Бортовое время последнего перехода CAN-шины в состояние Bus off
    busOffTimeGps: Union[Gps]
