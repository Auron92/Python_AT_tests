...
from stw_py_api_generator.legacy.stw_yaml_gen import TypeArray
...
@dataclass
class ArrayPythonClass(PythonClass):
    """Класс для создания типа array."""

    count: int = 0
    array_type_name: str = ''

    @classmethod
    def from_yaml_type(cls, array_type: TypeArray):
        ...
        return cls(
            ...
            array_type_name=desc['type_name'],
        )
